...
oommf-spack-v0.16.1:
	docker build -f Dockerfile --build-arg SPACK_VERSION=v0.16.1 -t oommf-spack-v0.16.1 .



.PHONY: Dockerfile-spack-v0.16.1 Dockerfile-spack-v0.16.2 oommf-spack run-spack
